...
public final class StatusMessages {
    ...
    public static final String ACCOUNT_EXPIRY_STATUS_UPDATED = "Account expiry status updated";
    ...
    public static final String SUBCATEGORY_IS_EXISTED = " Subcategory is already existed";
    public static final String COUPON_IS_EXISTED = "Coupon is already existed";
    ...
    public static final String GET_COUPONS_FAILED = "Get Coupons failed";
    ...
    public static final String COLOR_ATTRIBUTE_NOT_FOUND = "ColorAttribute not found";
