...
//import com.project.userservice.constants.IamportURL;
//
...
//
//        URL url = URI.create(IamportURL.CANCEL_URL.getURL()).toURL();
...
//        URL url = URI.create(IamportURL.GET_TOKEN_URL.getURL()).toURL();
//        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
//
//        // 요청 방식을 POST로 설정
//        conn.setRequestMethod("POST");
